    ...
    <Layout location={location} title={siteTitle}>
      ...
      <div>
        ...
        <p>
          ...
          From Raspi to websites, apps, and Cloud, I contributed to making the platform using a wide range of tech stacks. (Using <a href="https://www.datomic.com/" target="_blank">Datomic</a> to manage the database was the most fun part.)<br />
          Right now, I am part of a startup called KANKAK where I develop <a href="https://apps.apple.com/us/app/coffee-app/id1470570852"
